                    ...
                    <div className="text-container">
                            <div className="card_container">
                                ...
                                <div className="text-field">
                                    ...
                                    spezialisiert auf App- und Webentwicklung. Durch eigenständiges Lernen erweitere ich stetig mein Wissen und bleibe am Puls neuester 
                                    Technologien. Mein Ziel: Wertvolle Erfahrungen in App und Webentwicklung sammeln und innovative Lösungen gestalten.
                                    </p>
                                </div>
                     </div>
                </div>
